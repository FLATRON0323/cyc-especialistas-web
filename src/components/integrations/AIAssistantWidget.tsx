  ...
  return (
    <>
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 w-80 bg-white shadow-2xl rounded-2xl border border-gray-100 overflow-hidden z-[100] flex flex-col"
          ...
          >
            ...
            <div className="flex-grow p-6 flex flex-col items-center justify-center text-center bg-gray-50">
              ...
              <a href="https://wa.me/573054568996" className="text-sm bg-brand-blue text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-600 transition w-full">
      ...
      <button
        ...
        className="fixed bottom-6 right-24 bg-gradient-to-r from-brand-blue to-purple-600 text-white w-14 h-14 rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center z-[100] group"
      >
      ...
      >
        <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" alt="WA" className="w-8 h-8 filter brightness-0 invert" />
      </a>
    </>
  );
}
