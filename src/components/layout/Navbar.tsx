      ...
      <div className="bg-brand-dark text-white py-2 text-xs md:text-sm hidden md:block">
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://wa.me/573054568996" className="text-brand-accent font-bold hover:underline flex items-center gap-1">
              <Phone size={14} /> 305 456 8996
            </a>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <a href="#" className="flex items-center justify-center relative group">
              <img src="/logo.png" alt="C&C Logo" className="h-14 sm:h-20 w-auto object-contain transform group-hover:scale-105 transition-transform duration-300 drop-shadow-md" />
            </a>
          ...
          <div className="hidden lg:flex items-center gap-8 font-semibold text-sm text-gray-600">
            {['Soluciones', 'Proceso', 'Resultados', 'Testimonios', 'Software'].map((item) => (
          ...
          {/* CTA & Mobile Toggle */}
          <div className="flex items-center gap-4">
            <a href="https://wa.me/573054568996" className="hidden sm:flex bg-gradient-to-r from-brand-whatsapp to-green-500 text-white px-6 py-2.5 rounded-full font-bold items-center gap-2 hover:shadow-lg hover:shadow-green-500/30 hover:scale-105 transition-all">
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            ...
            <a href="https://wa.me/573054568996" className="bg-brand-whatsapp text-white w-full py-4 rounded-xl font-bold flex items-center justify-center gap-2 shadow-lg">
